...
start_activity_message           = "حله در حال حاضر می تونم فقط این چندتا قابلیت رو در اختیارتون بزارم حالا با توجه به نکاتی که گفتم روی چیزی که میخوای کلیک کن و اگه همچنان فکر میکنی که نام کاربری و پسوردت رو اشتباه زدی روی دکمه شروع دوباره بزن تا همه چی از سر گرفته بشه\n\nNow, according to the points I said, click on what you want, and if you still think that you have mistaken your username and password. Click the Start again to restart everything"
